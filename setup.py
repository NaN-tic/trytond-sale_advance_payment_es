...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-sale_advance_payment_es',
    download_url='https://github.com:nantic/trytond-sale_advance_payment_es.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-sale_advance_payment_es.git'
    },
    classifiers=[
